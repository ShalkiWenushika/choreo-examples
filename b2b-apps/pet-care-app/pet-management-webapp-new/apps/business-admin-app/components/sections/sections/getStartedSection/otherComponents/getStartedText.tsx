        ...
        <div className={ styles.getStartedSectionComponentGetStartedTextDiv }>
            <Panel bordered className={ styles.getStartedSectionComponentGetStartedTextPanel }>
                ...
                <Stack direction="column" spacing={ 50 } justifyContent="center">
                    ...
                    Pet Care App is a user-friendly and comprehensive mobile application 
                    designed to simplify and enhance pet management 
                    for pet owners. With its intuitive interface and a range of useful features, 
                    the app aims to provide convenience and support for all aspects of pet care.
                    </p>
